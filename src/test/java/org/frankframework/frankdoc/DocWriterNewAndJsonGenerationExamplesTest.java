...
public class DocWriterNewAndJsonGenerationExamplesTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			...
			{XsdVersion.STRICT, AttributeTypeStrategy.ALLOW_PROPERTY_REF, "type-attribute-digester-rules.xml", "org.frankframework.frankdoc.testtarget.examples.typeAttribute.Master", "typeAttributeStrict.xsd", null},
			{XsdVersion.COMPATIBILITY, AttributeTypeStrategy.ALLOW_PROPERTY_REF, "type-attribute-digester-rules.xml", "org.frankframework.frankdoc.testtarget.examples.typeAttribute.Master", "typeAttributeCompatibility.xsd", null},
		});
	}
