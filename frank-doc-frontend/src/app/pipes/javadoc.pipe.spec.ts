...
describe('JavadocPipe', () => {
  ...
  it('transforms markdown link to html link', () => {
    expect(
      pipe.transform('A [link](http://example.com) to an example website', {})
    ).toEqual(
  ...
  it('transforms javadoc quotes to normal quotes', () => {
    expect(pipe.transform('A javadoc \\"quote\\"', {})).toEqual(
      'A javadoc "quote"'
    );
  });
  ...
  it('transforms javadoc invalid link to html text', () => {
    expect(
      pipe.transform(
        'A javadoc {@link http://example.com link} to an example website',
        {}
      )
  ...
  it('transforms javadoc links without parentheses', () => {
    ...
    expect(
      pipe.transform(
        '{@link #setDestinationType destinationType} = {@link DestinationType#TOPIC TOPIC}',
        elements
      )
