...
public class DocWriterNewAndJsonGenerationExamplesTest {
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			...
			{XsdVersion.STRICT, AttributeTypeStrategy.ALLOW_PROPERTY_REF, "general-test-digester-rules.xml", null, "org.frankframework.frankdoc.testtarget.notes.Note", "notes.xsd", "notes.json"},
