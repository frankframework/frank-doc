...
public class DefaultClassnameTest extends BaseIntegrationTest {
	...
	public void testStrictXsd() throws Exception {
		var model = createModel(
			...
			null,
			"org.frankframework.frankdoc.testtarget.plural.config.defaultClassname.Master"
		);
		var actual = convertModelToXsd(model, XsdVersion.STRICT, AttributeTypeStrategy.ALLOW_PROPERTY_REF);

		assertXsdEqual(actual, "testPluralConflictDefaultOption.xsd");
	}
}
