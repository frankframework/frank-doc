...
public class WithoutAttributesTest extends BaseIntegrationTest {
	...
	public void testStrictXsd() throws Exception {
		var model = createModel(
			...
			null,
			"org.frankframework.frankdoc.testtarget.parent.without.attributes.Master"
		);
		var actual = convertModelToXsd(model, XsdVersion.STRICT, AttributeTypeStrategy.ALLOW_PROPERTY_REF);

		assertXsdEqual(actual, "handleParentOnlyExcludedAttributes.xsd");
	}
}
