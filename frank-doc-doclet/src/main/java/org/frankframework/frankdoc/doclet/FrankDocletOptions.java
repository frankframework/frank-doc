...
class FrankDocletOptions {
	...
	//TODO: Make this class obsolete by using FrankDocletOptionsNew instead. Almost done.
	...
	private enum Option {
		...
		private @Getter final String mavenName;

		Option(String mavenName) {
			this.mavenName = mavenName;
		}
	}

	private static final Map<String, Option> optionsByName;
	...
	static void validateOptions(String[][] options) throws InvalidDocletOptionsException {
		...
		for (String[] commandLineOption : options) {
